...
for i in range(0, 5):
    print("[INFO] x: ", str(x))
    n_filters = 2**(4 + i)
    x1 = Conv2D(n_filters, 3, activation='relu')(x)
    x2 = BatchNormalization()(x1)
    x3 = MaxPool2D(2)(x2)
    x_list.append([x, x1, x2, x3])
    print("[INFO] x_list: ", str(x_list))
...
x_list.append([x1, x2])
print("[INFO] length: ", len(x_list))

class_out = Dense(9, activation='softmax', name='class_out')(x2)
box_out = Dense(2, name='box_out')(x2)
